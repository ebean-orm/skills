...
the [ebean](https://github.com/ebean-orm/ebean) repo at `docs/guides/`.
To regenerate after editing guides:

```bash
# From the skills repo root (expects ../ebean as sibling)
./generate-references.sh

# Or specify the ebean repo location
